...
export class EmpresaPersonalComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder, private route: ActivatedRoute,
              ...
              private empresaModalidadService: EmpresaModalidadesService
              ) { }
  ...
  next(stepName: string, form) {
    ...
    switch (stepName) {
      ...
      case "CURSOS":
        ...
        this.empresaPersonalService.modificarInformacionTrabajo(this.persona.uuid, value).subscribe((data: Persona) => {
          this.toastService.showGenericToast(
            "Listo",
  ...
  confirmarEliminarPersonal() {
    ...
    this.empresaPersonalService.eliminarPersonal(this.persona.uuid).subscribe((data: Persona) => {
      this.toastService.showGenericToast(
        "Listo",
