...
public class EmpresaEscrituraRepresentanteServiceImpl implements EmpresaEscrituraRepresentanteService {
    ...
    @Override
    public List<EmpresaEscrituraRepresentanteDto> obtenerRepresentantesPorEscritura(String escrituraUuid) {
    ...
    @Override
    @Transactional
    public EmpresaEscrituraRepresentanteDto crearRepresentante(String escrituraUuid, String username, EmpresaEscrituraRepresentanteDto empresaEscrituraRepresentanteDto) {
        if(empresaEscrituraRepresentanteDto == null || StringUtils.isBlank(username) || StringUtils.isBlank(escrituraUuid)) {
    ...
    @Override
    @Transactional
    public EmpresaEscrituraRepresentanteDto modificarRepresentante(String escrituraUuid, String representanteUuid, String username, EmpresaEscrituraRepresentanteDto empresaEscrituraRepresentanteDto) {
        if(StringUtils.isBlank(escrituraUuid) || StringUtils.isBlank(username) || StringUtils.isBlank(representanteUuid) || empresaEscrituraRepresentanteDto == null) {
    ...
    @Override
    @Transactional
    public EmpresaEscrituraRepresentanteDto eliminarRepresentante(String escrituraUuid, String representanteUuid, String username, EmpresaEscrituraRepresentanteDto empresaEscrituraRepresentanteDto, MultipartFile multipartFile) {
        ...
        if(multipartFile != null) {
            ...
            try {
                rutaArchivoNuevo = archivosService.guardarArchivoMultipart(multipartFile, TipoArchivoEnum.DOCUMENTO_FUNDATORIO_BAJA_REPRESENTANTE, usuario.getEmpresa().getUuid());
