...
public interface EmpresaEscrituraApoderadoService {
    ...
    EmpresaEscrituraApoderadoDto eliminarApoderado(String escrituraUuid, String apoderadoUuid, String username, EmpresaEscrituraApoderadoDto empresaEscrituraApoderadoDto, MultipartFile multipartFile);
}
