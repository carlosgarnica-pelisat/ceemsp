...
public class EmpresaUniformeServiceImpl implements EmpresaUniformeService {
    ...
    public EmpresaUniformeServiceImpl(DaoToDtoConverter daoToDtoConverter, DtoToDaoConverter dtoToDaoConverter,
                                      ...
                                      EmpresaUniformeElementoService empresaUniformeElementoService, ArchivosService archivosService) {
    ...
    @Override
    public File descargarFotoUniforme(String uniformeUuid) {
        if(StringUtils.isBlank(uniformeUuid)) {
    ...
    @Override
    @Transactional
    public EmpresaUniformeDto guardarUniforme(String usuario, EmpresaUniformeDto empresaUniformeDto, MultipartFile multipartFile) {
        if(StringUtils.isBlank(usuario) || empresaUniformeDto == null || multipartFile == null) {
        ...
        String ruta = "";
        try {
            ruta = archivosService.guardarArchivoMultipart(multipartFile, TipoArchivoEnum.FOTO_UNIFORME, usuarioDto.getEmpresa().getUuid());
