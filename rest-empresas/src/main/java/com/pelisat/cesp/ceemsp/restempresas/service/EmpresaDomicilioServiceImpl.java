...
public class EmpresaDomicilioServiceImpl implements EmpresaDomicilioService {
    ...
    public EmpresaDomicilioDto obtenerDomicilioPorUuid(String empresaUsername, String domicilioUuid) {
        if(StringUtils.isBlank(empresaUsername) || StringUtils.isBlank(domicilioUuid)) {
        ...
        empresaDomicilioDto.setCalleCatalogo(catalogoService.obtenerCallePorId(empresaDomicilio.getCalleCatalogo()));
        empresaDomicilioDto.setColoniaCatalogo(catalogoService.obtenerColoniaPorId(empresaDomicilio.getColoniaCatalogo()));
        empresaDomicilioDto.setLocalidadCatalogo(catalogoService.obtenerLocalidadPorId(empresaDomicilio.getLocalidadCatalogo()));
    ...
    public EmpresaDomicilioDto guardarDomicilio(String empresaUsername, EmpresaDomicilioDto empresaDomicilioDto) {
        ...
        logger.info("Dando de alta nuevo domicilio en la empresa con uuid: [{}]", empresaUsername);

        UsuarioDto usuario = usuarioService.getUserByEmail(empresaUsername);
        ...
        empresaDomicilio.setEmpresa(usuario.getEmpresa().getId());
