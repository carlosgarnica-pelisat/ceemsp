...
public class CanAdiestramientoServiceImpl implements CanAdiestramientoService {
    ...
    public CanAdiestramientoServiceImpl(DaoToDtoConverter daoToDtoConverter, DtoToDaoConverter dtoToDaoConverter, DaoHelper<CommonModel> daoHelper,
                                        ...
                                        CanRepository canRepository, CanTipoAdiestramientoService canTipoAdiestramientoService, ArchivosService archivosService) {
    ...
    @Override
    public File obtenerAdiestramientoArchivo(String empresaUuid, String canUuid, String adiestramientoUuid) {
        if(StringUtils.isBlank(empresaUuid) || StringUtils.isBlank(canUuid) || StringUtils.isBlank(adiestramientoUuid)) {
    ...
    @Transactional
    @Override
    public CanAdiestramientoDto guardarCanAdiestramiento(String empresaUuid, String canUuid, String username, CanAdiestramientoDto canAdiestramientoDto, MultipartFile multipartFile) {
        if(StringUtils.isBlank(empresaUuid) || StringUtils.isBlank(canUuid) || StringUtils.isBlank(username) || canAdiestramientoDto == null || multipartFile == null) {
        ...
        try {
            ruta = archivosService.guardarArchivoMultipart(multipartFile, TipoArchivoEnum.CONSTANCIA_ADIESTRAMIENTO_CAN, empresaUuid);
    ...
    @Transactional
    @Override
    public CanAdiestramientoDto modificarCanAdiestramiento(String empresaUuid, String canUuid, String adiestramientoUuid, String username, CanAdiestramientoDto canAdiestramientoDto, MultipartFile multipartFile) {
        ...
        if(multipartFile != null) {
            ...
            try {
                rutaArchivoNuevo = archivosService.guardarArchivoMultipart(multipartFile, TipoArchivoEnum.CONSTANCIA_ADIESTRAMIENTO_CAN, empresaUuid);
